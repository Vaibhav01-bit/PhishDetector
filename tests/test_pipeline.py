...
def test_pipeline():
    ...
    test_cases = [
        ...
        (
            "https://this-is-a-very-long-domain-name-that-should-trigger-domain-length-check-because-it-is-over-50-chars.com",
            WARNING,
            "Domain Length",
        ),
    ]
    ...
    for url, expected_status, description in test_cases:
        ...
        try:
            ...
            if expected_status == WARNING and status == PHISHING:
                print(
                    "  -> OK (Phishing is acceptable if multiple warnings or strict checks triggered)"
                )
