...
from pipeline.layers import Layer0_Validation, SAFE, WARNING, INVALID
...
def test_validation():
    ...
    test_cases = [
        ...
        ("https://example.com/login?redirect=http://malicious.com", WARNING, "Nested URL in query"),
        ("Scanning:https://www.youtube.com/https://www.youtube.com/", WARNING, "Prefixed Nested URL"),
